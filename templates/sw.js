...
// borrowing heavily from adactio's sw patterns here... Thanks JK!
    ...
    const staticAssets = [
        ...
        '{{ baseUrl }}fonts/Proxima-Nova-Black.woff2',
        '{{ baseUrl }}fonts/Proxima-Nova-Bold.woff2',
        '{{ baseUrl }}fonts/Proxima-Nova-Regular.woff2',
        '{{ baseUrl }}fonts/Proxima-Nova-Light.woff2',
